...
Gialle pubblicato da SEAT Pagine Gialle dal 1981 al 2014, e di indicizzarne le caratteristiche principali delle varie annate;
tramite questo censimento sono stati individuati finora **1994 fascicoli accertati** su 34 annate, 20 regioni e
...
- [`fascicoli_lungo.csv`](dati/fascicoli_lungo.csv) — una riga per fascicolo e annata: la forma adatta al riuso, con l'ambito coperto — l'intero territorio, i soli dintorni del capoluogo, la sola provincia — e una nota per i pochi fascicoli che hanno una particolarità da segnalare
...
- [`aggregati_per_annata.csv`](dati/aggregati_per_annata.csv) — calendario editoriale e foliazione, dati aggregati
