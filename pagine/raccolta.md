...
Di seguito invece la lista delle regioni. Per ciascuna regione è presente una grande tabella con in
...
**copertina sottile** è la copertina stessa a fare da pagina 1 e la seconda di copertina da pagina 2,
così che quella che nell'altro caso sarebbe la pagina 1 diventa qui la pagina 3. In raccolta la
copertina sottile compare fra il 1993/94 e il 2005/06.

La seconda regola riguarda la fine del fascicolo. Il conteggio regolare esclude terza e quarta di
copertina, che non portano numero, ed è quello riportato nelle tabelle. Quando nei dati accanto a quel
numero ne compare un altro fra parentesi, più alto, vuol dire che quelle pagine sono state usate per
contenuto proprio del fascicolo — una mappa non indicizzata, la parte finale dell'elenco delle vie —
e che quindi eccedono il conteggio regolare. Uno scarto di una pagina riguarda la sola terza di
